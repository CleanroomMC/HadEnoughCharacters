    ...
    public enum Item {
        ...
        public String getComment() {
            switch (this) {
                ...
                case ENABLE_HEI:
                    return "Set to false to disable HEI support.";
                case ENABLE_PSI:
            ...
            switch (this) {
                ...
                case LIST_DEFAULT_STRING:
                    return new String[]{
                            ...
                            "appeng.client.me.ItemRepo:lambda$updateView$0", //AE2 Unofficial Extended Life item search
                            "appeng.client.gui.implementations.GuiInterfaceConfigurationTerminal:refreshList",  //AE2 Unofficial Extended Life InterfaceConfigurationTerminal
                            "appeng.client.gui.implementations.GuiInterfaceConfigurationTerminal:itemStackMatchesSearchTerm"  //AE2 Unofficial Extended Life InterfaceConfigurationTerminal
                    };
                case LIST_DEFAULT_REGEXP:
                    return new String[]{
        ...
        public void sync() {
            switch (this) {
                ...
                case LIST_METHOD_BLACKLIST:
                    ...
                    break;
                case ENABLE_HEI:
                    enableHEI = getProperty().getBoolean();
                    break;
                case ENABLE_PSI:
